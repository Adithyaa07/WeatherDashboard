    ...
    <>
      <div className="hourly_updated_weather_container">
        <div
          ...
          style={{ color: "#0D9BE5" }}
        >
          <h6 style={{ fontWeight: 1000, marginBottom: "15px" }}>
    Forecast for Travellers to plan there journey accordingly to the weather
          </h6>
          <p className="mb-0">
            considering the weather forecast for the next 5 days
            <i
